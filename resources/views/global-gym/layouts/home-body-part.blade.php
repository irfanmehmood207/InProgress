<div class="fh5co-hero">
			...
			<div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image: url(http://localhost/globalgym/public/images/home-image.jpg);">
...
<div id="fh5co-schedule-section" class="fh5co-lightgray-section">
							...
							<div class="schedule-content active" data-day="sunday">
								<div class="col-md-3 col-sm-6">
									<div class="program program-schedule">
										<img src="http://localhost/globalgym/public/images/fit-dumbell.svg" alt="Cycling">
								...
								<div class="col-md-3 col-sm-6">
									<div class="program program-schedule">
										<img src="http://localhost/globalgym/public/images/fit-yoga.svg" alt="">
										<small>06AM-7AM</small>
										<h3>Yoga Programs</h3>
								...
								<div class="col-md-3 col-sm-6">
									<div class="program program-schedule">
										<img src="http://localhost/globalgym/public/images/fit-cycling.svg" alt="">
										<small>06AM-7AM</small>
								...
								<div class="col-md-3 col-sm-6">
									<div class="program program-schedule">
										<img src="http://localhost/globalgym/public/images/fit-boxing.svg" alt="Cycling">
										<small>06AM-7AM</small>
		...
		<div class="fh5co-parallax" style="background-image: url(http://localhost/globalgym/public/images/home-image-3.jpg);" data-stellar-background-ratio="0.5">
		...
		<div id="fh5co-programs-section">
			<div class="container">
				...
				<div class="row text-center">
					...
					<div class="col-md-4 col-sm-6">
						<div class="program animate-box">
							<img src="http://localhost/globalgym/public/images/fit-swimming.svg" alt="">
					...
					<div class="col-md-4 col-sm-6">
						<div class="program animate-box">
							<img src="http://localhost/globalgym/public/images/fit-massage.svg" alt="">
							<h3>Massage</h3>
							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
							<span><a href="#" class="btn btn-default">Join Now</a></span>
						</div>
		...
		<div id="fh5co-team-section" class="fh5co-lightgray-section">
			<div class="container">
				...
				<div class="row text-center">
					<div class="col-md-4 col-sm-6">
						<div class="team-section-grid animate-box" style="background-image: url(http://localhost/globalgym/public/images/trainer-1.jpg);">
					...
					<div class="col-md-4 col-sm-6">
						<div class="team-section-grid animate-box" style="background-image: url(http://localhost/globalgym/public/images/trainer-2.jpg);">
							<div class="overlay-section">
								<div class="desc">
									<h3>James Smith</h3>
					...
					<div class="col-md-4 col-sm-6">
						<div class="team-section-grid animate-box" style="background-image: url(http://localhost/globalgym/public/images/trainer-3.jpg);">
							<div class="overlay-section">
								<div class="desc">
									<h3>John Doe</h3>
					...
					<div class="col-md-4 col-sm-6">
						<div class="team-section-grid animate-box" style="background-image: url(http://localhost/globalgym/public/images/trainer-4.jpg);">
							<div class="overlay-section">
								<div class="desc">
									<h3>John Doe</h3>
									<span>Chief Executive Officer</span>
					...
					<div class="col-md-4 col-sm-6">
						<div class="team-section-grid animate-box" style="background-image: url(http://localhost/globalgym/public/images/trainer-5.jpg);">
							<div class="overlay-section">
								<div class="desc">
									<h3>John Doe</h3>
									<span>Chief Executive Officer</span>
					...
					<div class="col-md-4 col-sm-6">
						<div class="team-section-grid animate-box" style="background-image: url(http://localhost/globalgym/public/images/trainer-6.jpg);">
							<div class="overlay-section">
								<div class="desc">
									<h3>John Doe</h3>
									<span>Chief Executive Officer</span>
		...
		<div class="fh5co-parallax" style="background-image: url(http://localhost/globalgym/public/images/home-image-2.jpg);" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
						...
						<div class="col-md-12 col-md-offset-0">
							<div class="fh5co-blog animate-box">
								<div class="inner-post">
									<a href="#"><img class="img-responsive" src="http://localhost/globalgym/public/images/blog-1.jpg" alt=""></a>
								</div>
								<div class="desc">
